...
| `mean_latency_ms_uncached` | 4847.235 | 59.890 | 4782.000 | 4953.400 | [4814.625, 4884.585] |
| `p95_latency_ms_uncached` | 5217.100 | 109.639 | 5102.000 | 5413.000 | [5155.700, 5284.100] |
| `total_tokens_reported` | 86603.500 | 1.581 | 86599.000 | 86604.000 | [86602.500, 86604.000] |

## Per-Run Results

| Run | Valid JSON | LLM-positive | TP | FP | TN | FN | Precision | Recall | F1 | Event recall | Cluster recall | Stream load | Tokens |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,599 |
| 2 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
| 3 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
| 4 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
| 5 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
| 6 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
| 7 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
| 8 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
| 9 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
| 10 | 20 | 15 | 10 | 5 | 5 | 0 | 0.667 | 1.000 | 0.800 | 1.000 | 1.000 | 0.237 | 86,604 |
...
- `outputs\reports\streaming_llm_stability_gap100_v3_n10\stability_summary.json`
- per-run JSONL/metadata/evaluation files under `outputs\reports\streaming_llm_stability_gap100_v3_n10`
