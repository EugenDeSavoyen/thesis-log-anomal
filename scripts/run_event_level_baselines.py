...
from thesis_log_anomaly.baselines.event_level import run_event_level_baselines
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run zero-LLM event-level baselines inside GEV-suspicious windows."
    )
    ...
    parser.add_argument(
        "--output-report",
        default="outputs/reports/event_level_baselines_bgl_multiblock.json",
    )
    parser.add_argument(
        "--output-table",
        default="outputs/reports/event_level_baselines_bgl_multiblock.csv",
    )
    parser.add_argument(
        "--output-models",
        default="outputs/models/event_level_baselines_bgl_multiblock.joblib",
    )
    ...
    report = run_event_level_baselines(
        windows_after_gev,
